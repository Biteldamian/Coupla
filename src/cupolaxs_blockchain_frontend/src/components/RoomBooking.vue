<template>
  ...
  <div class="container mx-auto px-4">
    ...
    <div>
      <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Start date: <VueDatePicker v-model="startBookingDate" :format="formatDate" :enable-time-picker="false" :max-date="maxDate" :min-date="minDate"></VueDatePicker></p>
    </div>
...
const bookCell = async (cellId) => {
  ...
  if(startBookingDate.value == null){
...
/**
 * Disables all dates further that a month for now
 */
