...
export const canisterId = process.env.CANISTER_ID_CUPOLAXS_BLOCKCHAIN_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./cupolaxs_blockchain_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the cupolaxs_blockchain_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./cupolaxs_blockchain_backend.did.js")._SERVICE>}
 */
export const cupolaxs_blockchain_backend = createActor(canisterId);
