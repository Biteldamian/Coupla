...
export const canisterId = process.env.CANISTER_ID_CUPOLAXS_BLOCKCHAIN_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./cupolaxs_blockchain_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the cupolaxs_blockchain_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./cupolaxs_blockchain_frontend.did.js")._SERVICE>}
 */
export const cupolaxs_blockchain_frontend = createActor(canisterId);
